...
<html>
    ...
    <body>
        ...
        <div id="show-items" class="content scaffold-show" role="main">
            ...
            <f:display bean="items" />
            <g:form resource="${this.items}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.items}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
