...
<html>
    ...
    <body>
        <a href="#create-customers" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-customers" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.customers}" method="POST">
                <fieldset class="form">
